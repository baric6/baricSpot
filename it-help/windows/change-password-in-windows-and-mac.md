...
It’s a quick way to change your account password. If this doesn’t work, you can use the Settings app to do the same.



## Windows and Mac Change Password PDF

{% embed url="https://www.assumption.edu/sites/default/files/2020-01/EmployeePwsProcess.pdf" %}
