...
Authorization => access to resources after sign in

**IAM tools**

{% embed url="https://solutionsreview.com/identity-management/the-best-free-and-open-source-identity-management-tools/" %}

**Helpful links**

Guide to Identity and Access Management

{% embed url="https://www.strongdm.com/iam" %}

**IAM as a service IDAAS**

{% embed url="https://www.strongdm.com/blog/identity-as-a-service" %}
