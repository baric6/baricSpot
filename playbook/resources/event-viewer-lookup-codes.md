# Event viewer lookup codes

## Event viewer lookup codes <a href="#event-viewer-lookup-codes" id="event-viewer-lookup-codes"></a>

#### what events to look for <a href="#what-events-to-look-for" id="what-events-to-look-for"></a>

4625 / 529-539 – FAILED LOGIN\
4771 – FAILED KERBEROS PRE AUTHENTICATION\
4765 / 4766 – SID HISTORY ADDED TO AN ACCOUNT / FAILED\
4794 – ATTEMPT MADE TO SET DSRM PASSWORD\
4793/643, 4713/617, 4719/612 – POLICY CHANGES\
4735/639, 4737/641, 4755/659 – SECURITY ENABLED GROUPS CHANGED\
4728/632, 4732/636, 4756/660 – USERS BEING ADDED TO SECURITY ENABLED GROUPS\
1102 / 517 – AUDIT LOG CLEARED\
4648 / 552 – LOGON ATTEMPTED USING EXPLICIT CREDENTIALS\
4697 / 601 – SERVICE INSTALLED\
4688 / 592 – PROCESS CREATED\
4672 / 576 – SPECIAL PRIVILEGES ASSIGNED TO NEW LOGON\
4698 / 4702 / 602 – SCHEDULED TASK CREATED / UPDATED\
4720 / 624 – A LOCAL USER ACCOUNT WAS CREATED

#### all events <a href="#all-events" id="all-events"></a>

## 1000 <a href="#id-1000" id="id-1000"></a>
...
## 4000 <a href="#id-4000" id="id-4000"></a>
...
## 5000 <a href="#id-5000" id="id-5000"></a>
...
## 6000 <a href="#id-6000" id="id-6000"></a>
